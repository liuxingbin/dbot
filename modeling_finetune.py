...
@register_model
def base_patch16_384(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def large_patch16_384(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def large_patch16_512(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def huge_patch14_224(pretrained=False, **kwargs):
    model = VisionTransformer(
...
@register_model
def huge_patch14_448(pretrained=False, **kwargs):
    model = VisionTransformer(
        img_size=448, patch_size=14, embed_dim=1280, depth=32, num_heads=16, mlp_ratio=4, #qkv_bias=True,
        norm_layer=partial(nn.LayerNorm, eps=1e-6), **kwargs)
    model.default_cfg = _cfg()
    return model