...
def get_parameter_groups(model, weight_decay=1e-5, skip_list=(), get_num_layer=None, get_layer_scale=None, **kwargs):
    ...
    for name, param in model.named_parameters():
        ...
        if len(param.shape) == 1 or name.endswith(".bias") or name in skip_list:
            group_name = "no_decay"
            this_weight_decay = 0.
        elif 'decode_task_layer' in name and kwargs.get('task_layer_weight_decay', 0.) > 0:
            group_name = "task_layer_decay"
            this_weight_decay = kwargs.get('task_layer_weight_decay', 0.)
        else:
            group_name = "decay"
